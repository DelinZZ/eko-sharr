    ...
    <div className="text-gray-800 relative">
      ...
      <section className="max-w-6xl mx-auto px-4 py-10 text-gray-700">
        ...
        <div className="mb-12 leading-relaxed text-justify">
          <p>
            The Ancient civilizations indulged themselves in milk, cheese and dairy products. In the year 2000 B.C. not only did the Greeks use
            the milk and dairy products, but they also offered them as gifts to the Gods. Aristotle, the Greek philosopher, and the Great Homer both
            wrote about milk and dairy products and the animals which produced milk. Milk and cheese was consumed by the Romans as well.
            Diocletian wrote a book on the rules, regulations and price of cheese in the year 300 BC. Cheese was considered such delicate and
            precious food, so the Roman soldiers passed down the secret of cheese making throughout the numerous provinces under the Roman
            Empire. In the early Middle Ages, the barbarian tribes (Huns, Goths, Franks and the Germanic tribes) fed on milk, cheese and meat. In the
            late Middle Ages, a great number of monasteries became centers for milk and cheese production, and these centers were main suppliers
            for the King's castles and towns. The ancient records provide information that each priest was allowed to consume a kilogram of
            cheese on a weekly basis. In the Holy Quran, in the chapters dedicated to milk, it is said that the milk and blood travel through
            the same blood vessels, however the milk is white and the blood is red, therefore each believer should ask himself/herself the question
            why that is. In the Islamic culture, from the early age, milk and dairy products were consumed as main food products and were
